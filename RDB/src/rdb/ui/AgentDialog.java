...
public class AgentDialog extends javax.swing.JDialog {
  ...
  public AgentDialog(java.awt.Frame parent, Agent model) {
    super(parent, true);
    initComponents();
    ...
    JTextField[] primaryFields
        = new JTextField[Agent.NUL.getTablePrimaryKeys().length];
  ...
  private void populateFields() {
    ...
    this.fields[++index].setText(Transcriber.toField(model.getAgentFee()));
    this.fields[++index].setText(Transcriber.toField(model.getContractId()));
    setModified(false);
  }
  ...
  private void save() {
    ...
    this.model.setName(Transcriber.toString(
        this.fields[++index].getText()));
    this.model.setAgentFee(Transcriber.toDouble(
        this.fields[++index].getText()));
    this.model.setContractId(Transcriber.toInt(
        this.fields[++index].getText()));
  }
  ...
  private Object getModelData(int index) {
    switch (index) {
      ...
      case 2: return this.model.getAgentFee();
      case 3: return this.model.getContractId();
    }
