...
public class ContractDialog extends javax.swing.JDialog {
  ...
  public ContractDialog(java.awt.Frame parent, Contract model) {
    super(parent, true);
    initComponents();
    ...
    JTextField[] primaryFields
        = new JTextField[Contract.NUL.getTablePrimaryKeys().length];
  ...
  private void populateFields() {
    ...
    this.fields[++index].setText(Transcriber.toField(model.getSalary()));
    this.fields[++index].setText(Transcriber.toField(model.getDuration()));
  ...
  private void save() {
    ...
    this.model.setSalary(Transcriber.toDouble(
        this.fields[++index].getText()));
    this.model.setDuration(Transcriber.toInt(
        this.fields[++index].getText()));
  ...
  private Object getModelData(int index) {
    switch (index) {
      ...
      case 1: return this.model.getSalary();
      case 2: return this.model.getDuration();
      case 3: return this.model.getGmId();
    }
