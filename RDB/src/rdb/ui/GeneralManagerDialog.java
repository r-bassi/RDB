...
public class GeneralManagerDialog extends javax.swing.JDialog {
  private static final Table TABLE = GeneralManager.NUL;
  private final JTextField[] fields;
  private final GeneralManager model;
  private Object fieldData;

  public GeneralManagerDialog(java.awt.Frame parent, GeneralManager model) {
    super(parent, true);
    initComponents();
    ...
    JTextField[] primaryFields
        = new JTextField[GeneralManager.NUL.getTablePrimaryKeys().length];
  ...
  public GeneralManager getModel() {
    return this.model;
  }
  ...
  private void populateFields() {
    ...
    this.fields[++index].setText(Transcriber.toField(model.getExperience()));
    this.fields[++index].setText(Transcriber.toField(model.getTeamCity()));
    this.fields[++index].setText(Transcriber.toField(model.getTeamName()));
    setModified(false);
  }
  ...
  private void save() {
    ...
    this.model.setName(Transcriber.toString(
        this.fields[++index].getText()));
    this.model.setExperience(Transcriber.toInt(
        this.fields[++index].getText()));
    this.model.setTeamCity(Transcriber.toString(
        this.fields[++index].getText()));
    this.model.setTeamName(Transcriber.toString(
        this.fields[++index].getText()));
  }
  ...
  private Object getModelData(int index) {
    switch (index) {
      ...
      case 1: return this.model.getPasscode();
      case 2: return this.model.getName();
      case 3: return this.model.getExperience();
      case 4: return this.model.getTeamCity();
      case 5: return this.model.getTeamName();
    }
