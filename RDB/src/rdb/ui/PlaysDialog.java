...
public class PlaysDialog extends javax.swing.JDialog {
  private static final Table TABLE = Plays.NUL;
  private final JTextField[] fields;
  private final Plays model;
  private Object fieldData;

  public PlaysDialog(java.awt.Frame parent, Plays model) {
    super(parent, true);
    initComponents();
    ...
    JTextField[] primaryFields
        = new JTextField[Plays.NUL.getTablePrimaryKeys().length];
    System.arraycopy(this.fields, 0, primaryFields, 0, primaryFields.length);
    if (model != null)
      for (int i = model.getUserId() == NUL_STRING
  ...
  private void populateLabels() {
    JLabel[] labels = new JLabel[] {
      this.label0, this.label1, this.label2
    };
  ...
  private void populateFields() {
    int index = 0;
    this.fields[index].setText(Transcriber.toField(model.getUserId()));
  ...
  private void save() {
    int index = 0;
    this.model.setUserId(Transcriber.toString(
  ...
  private Object getModelData(int index) {
    switch (index) {
      case 0: return model.getUserId();
      case 1: return model.getTeamCity();
      case 2: return model.getTeamName();
    }
